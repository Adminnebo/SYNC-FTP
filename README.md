...
| Origen | Comando | Workflow | Bucket (secret) |
|---|---|---|---|
| FTP | `node migrate.js sync` | `sync-ftp-images.yml` (07:00 UTC) | `SUPABASE_BUCKET` |
| Google Drive (público) | `node drive-sync.js` | `sync-drive-images.yml` (07:30 UTC) | `DRIVE_SUPABASE_BUCKET` |

Ambos son _stateless_: en cada corrida listan lo que ya existe en su bucket y suben solo las imágenes nuevas.
